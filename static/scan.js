...
const _INSTALL_STAPPEN = {
  ...
  "ios-safari": "<b>iPhone / iPad — Safari</b>" + _SHARE_CUE + "<ol " + _OL + "><li>Tik op het <b>deel-icoon</b> hierboven.</li><li>Scroll en kies <b>‘Zet op beginscherm’</b>.</li><li>Tik rechtsboven op <b>‘Voeg toe’</b>.</li></ol>",
  "ios-chrome": "<b>iPhone / iPad — Chrome</b>" + _SHARE_CUE + "<ol " + _OL + "><li>Tik op het <b>deel-icoon</b> (of het <b>⋯</b>-menu).</li><li>Kies <b>‘Zet op beginscherm’</b>.</li></ol><p style='margin-top:8px;color:var(--muted);font-size:.8rem;'>Werkt het niet? Open deze pagina in <b>Safari</b>.</p>",
  "ios-firefox": "<b>iPhone / iPad — Firefox</b><p style='margin-top:6px;'>Op iOS gaat installeren het makkelijkst via <b>Safari</b>:</p>" + _SHARE_CUE + "<ol " + _OL + "><li>Open deze pagina in <b>Safari</b>.</li><li>Tik op het <b>deel-icoon</b> → <b>‘Zet op beginscherm’</b>.</li></ol>",
